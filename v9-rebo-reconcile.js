(() => {
  ...
  const includedRows=(cur=M.selectedMonth,month=M.selectedMonth)=>M.state.ledger.filter(x=>x.month===month&&x.reflect!=='미반영'&&x.currency===cur&&x.category==='상환·지원금'&&x.cashMode==='카드청구포함');
